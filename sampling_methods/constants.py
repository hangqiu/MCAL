...
def get_base_AL_mapping():
  ...
  # added for active labeling
  from sampling_methods.entropy import Entropy
  from sampling_methods.least_confidence import LeastConfidence
  AL_MAPPING['entropy'] = Entropy
  AL_MAPPING['least_confidence'] = LeastConfidence
